  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        // Unified 403 handling for both cases
        if (response.status === 403) {
          window.location.href = '/Dashboard'; // Force full page redirect
          return;
        }
...
// Remove the separate self-profile check useEffect/ Runs when the 'userId' prop changes
